...
\headsep 4.3em
\lhead{\includegraphics[scale=0.08]{Figures/polytech.png}}
\chead{}
\rhead{\includegraphics[scale=0.03]{Figures/psud.png}}
\lfoot{ZOU Fangzheng}
...
如果你发现copy了我的头文件区域之后不能compiler，十有八九是因为我定义的字体在你系统的字体库里没有安装，注释掉就可以了！
\par
